...
for (var i = 0; i < 3; i++)
{
	...
	if (lay_id != -1)
	{
		...
		switch (ts)
		{
			...
			case tileset_tile_beachtest: t = sprite_tile_beachtest; break;
			case tileset_tile_beachtest2: t = sprite_tile_beachtest2; break;
			case tileset_tile_beachtest2dark: t = sprite_tile_beachtest2dark; break;
			case tileset_chateau1: t = tile_chateau1; break;
			case tile_desert_tileset: t = tile_desert; break;
			...
			case tileset_tile_forest: t = sprite_tile_forest; break;
			case tile_forestplain: t = spr_forestplaintile; break;
			case tileset_tile_forest1_shade: t = sprite_tile_forest1_shade; break;
			case tileset_tile_forest2: t = sprite_tile_forest2; break;
			case tileset_freezer: t = bg_tilefreezer; break;
			case tileset_freezer2: t = tile_freezer2; break;
			case tileset_graveyard: t = tile_graveyard1; break;
			...
			case tile_factory2: t = tile_factory2424; break;
			case tile_kidsparty: t = spr_kidspartytile; break;
			case tileset_tile_kungfu: t = sprite_tile_kungfu; break;
			case tileset_tile_kungfucity: t = tile_kunfucity; break;
			case tileset_tile_kungfustructure: t = sprite_tile_kungfustructure; break;
			...
			case tileset_tile_minigolf: t = sprite_tile_minigolf; break;
			case tileset_tile_minigolf2: t = sprite_tile_minigolf2; break;
			case tileset_tile_minigolf2_shad: t = sprite_tile_minigolf2_shad; break;
			case tileset_secret: t = tile_secret; break;
			case tileset_tile_space1: t = sprite_tile_space1; break;
			case tileset_tile_spaceback1: t = sprite_tile_spaceback1; break;
			case tileset_tile_space2: t = sprite_tile_space2; break;
			case tile_space3props: t = spr_space3props; break;
			case tileset_pinball1: t = tile_pinball1; break;
			case tileset_pinball2: t = tile_pinball2; break;
			case tileset_pinball3: t = tile_pinball3; break;
			case tile_saloonwooden: t = spr_pinballwooden; break;
			case tileset_tile_war1: t = sprite_tile_war1; break;
			case tileset_tile_war2: t = sprite_tile_war2; break;
			case tileset_tile_war3: t = sprite_tile_war3; break;
			case tileset_tile_war4: t = sprite_tile_war4; break;
			case tile_warlab: t = spr_warlab; break;
			case tileset_tile_war1shadow: t = sprite_tile_war1shadow; break;
			case tileset_tile_space2shadow: t = sprite_tile_space2shadow; break;
			case tileset_tile_citycarnival: t = sprite_tile_citycarnival; break;
			case tileset_tile_citydark: t = sprite_tile_citydark; break;
